        ...
        */}
        ...
        <div className="offcanvas offcanvas-start" id="offcanvasNavbar">
          ...
          <div className="offcanvas-body justify-content-end">
            {navigation.map((nav) => (
              <Link
                className="nav-link nav-item py-1 py-md-none px-md-3"
                key={nav.name}
                to={nav.componente}
              >
                {nav.name}
        ...
        <div className="d-none d-md-inline-flex">
          ...
          <div className="dropstart">
            ...
            <ul class="dropdown-menu">
              <li>
                <p className="mx-2 text-center">Perfil do Administrador</p>
              </li>
              <li>
              ...
              <li>
                <a className="dropdown-item text-bg-danger" href="#">
                  Sair
                </a>
              </li>
            </ul>
